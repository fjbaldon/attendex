...
export const getArrivalsColumns = (attributes: Attribute[]): ColumnDef<EntryDetailsDto>[] => {
    ...
    const punctualityColumn: ColumnDef<EntryDetailsDto> = {
        ...
        header: "Status",
        cell: ({row}) => <div className="text-sm capitalize">{row.original.punctuality.toLowerCase()}</div>,
    };
